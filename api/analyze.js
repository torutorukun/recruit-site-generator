...
■ numbersセクションには設立年月・設立日は入れない。設立はfoundedフィールドのみに入れること。
...
module.exports = async function(req, res) {
  ...
  const { text, password, hpUrl, tldvUrl, extraInfo,
    ...
    foundedDate, salesInfo, ivPerson, ivQ1, ivA1, ivQ2, ivA2, ivQ3, ivA3, theme, font } = req.body;
  ...
  try {
    ...
    return res.status(200).json({result: {...parsed, theme: theme||"navy", font: font||"classic"}});
  } catch (e) {
